...
// assets
var assetInput = 'projects/mapbiomas-argentina/assets/LAND-COVER/COLLECTION-2/INTEGRATION/mapbiomas_argentina_collection1_integration_v5_buffer';
...
mapbiomasPalette[75] = '#6fc179';  // Turberas
...
var classes = [
    ...
    [75, 2], //  2. Non Forest Natural Formation
...
var filtradas = ee.ImageCollection("projects/mapbiomas-argentina/assets/SECONDARY-VEGETATION-DEFORESTATION/COLLECTION-1/deforestacion-vegetacion-secundaria-ft")
var transitions = filtradas.mosaic() //ee.Image(obj.get('classification'));
//
//
...
// No observado[27] 
    legend: {
        ...
        75: { 'color': palette[75], 'name': 'Turberas' },
        // 67: { 'color': palette[67], 'name': 'Matorrales y arbustales Abiertos' }
        
    },

    legendDeforestation: {
        0: { 'color': transitionsPalette[0], 'name': 'Sin información'} ,
        1: { 'color': transitionsPalette[1], 'name': 'Antrópico' },
        2: { 'color': transitionsPalette[2], 'name': 'Veg. Primaria' },
        3: { 'color': transitionsPalette[3], 'name': 'Veg. Secundaria' },
        4: { 'color': transitionsPalette[4], 'name': 'Pérdida de Veg. Primária' },
        5: { 'color': transitionsPalette[5], 'name': 'Recuperación para Veg. Secundária' },
        6: { 'color': transitionsPalette[6], 'name': 'Pérdida Veg. Secundária' },
        7: { 'color': transitionsPalette[7], 'name': 'Otras transiciones' },
    },
